...
namespace GoodStuff
{
    public class Convertion
    {
        ...
        public static string ToString(decimal sDecimal)
        {
            return sDecimal.ToString();
        }
        public static string ToString(double sDouble)
        {
            return sDouble.ToString();
        }
        public static string ToString(float sFloat)
        {
            return sFloat.ToString();
        }
        public static string ToString(int sInt)
        {
        ...
        public static int ToInt(char[] sString_chars)
        {
            return ToInt(ToString(sString_chars));
        }
        public static int ToInt(byte[] sString_bytes)
        {
            return ToInt(ToString(sString_bytes));
        }
        public static int ToInt(string sString)
        {
            return int.Parse(sString);
        }
        public static int ToInt(decimal sDecimal)
        {
            string sString = GetPart(ToString(sDecimal).Replace(".", ","), 0, ",");
            return ToInt(sString);
        }
        public static int ToInt(double sDouble)
        {
            string sString = GetPart(ToString(sDouble).Replace(".", ","), 0, ",");
            return ToInt(sString);
        }
        public static int ToInt(float fFloat)
        {
            string sString = GetPart(ToString(fFloat).Replace(".", ","), 0, ",");
            return ToInt(sString);
        }



        public static string GetPart(string sString, int iPart, string separator)
        {
            string s_ret = sString;
            if (sString.Contains(separator))
            {
                s_ret = sString.Split(separator.ToCharArray()[0])[iPart];
            }
            return s_ret;
        }
    }
